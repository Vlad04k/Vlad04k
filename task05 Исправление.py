...
#Задача6
csv_file1 = "ts_00.csv"
def plot_combined_graph(csv_file1):
    data_df1 = pd.read_csv(csv_file1)
    return data_df1
x_y = data_df1
csv_file2 = "ts_03.csv"
def plot_combined_graph(csv_file2):
    data_df2 = pd.read_csv(csv_file2)
    return data_df2
x1_y1 = data_df2
csv_file3 = "ts_laba.csv"
def plot_combined_graph(csv_file3):
...
print(plt.show())
plot_combined_graph('ts_00.csv')
plot_combined_graph('ts_03.csv')
plot_combined_graph('ts_laba.csv')